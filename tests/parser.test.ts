...
describe("parseComment", () => {
    ...
    `);
        expect(parseComment(`@Pothos.omit(create,update,)`))
            .toMatchInlineSnapshot(`
      Array [
        "create",
        "update",
    ...
    `);
        expect(
            parseComment(`@Pothos.omit(create,update,`)
        ).toMatchInlineSnapshot(`null`);
        expect(
            parseComment(`@Pothos.omit(create,updatex)`)
        ).toMatchInlineSnapshot(`null`);
        expect(parseComment(`test @Pothos.omit(create,update) test`))
            .toMatchInlineSnapshot(`
      Array [
        "create",
        "update",
